<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download" @click="handleExportXls('字典项')">导出</a-button>
      <a-upload
        name="file"
    ...
    <mDictItem-modal ref="modalForm" @ok="modalFormOk"></mDictItem-modal>
  </a-card>
</template>
...
import MDictItemModal from './modules/MDictItemModal'
