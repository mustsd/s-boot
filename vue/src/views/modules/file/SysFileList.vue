  ...
  <a-card :bordered="false">
        ...
        <a-row :gutter="24">
          ...
          <a-col :md="6" :sm="8">
            <a-form-item label="类型">
              <j-dict-select-tag v-model="queryParam.bucket" placeholder="请选择类型" dictCode="bucket" />
            </a-form-item>
          </a-col>
          <a-col :md="6" :sm="8">
    ...
    <div class="table-operator">
      <a-upload
        ...
        @change="onFinish"
      >
        <a-button type="primary" icon="upload" :disabled="false" v-auth="'uploadFile'">上传</a-button>
      </a-upload>
      <a-button type="primary" icon="download" @click="handleExportXls('OSS文件')">导出</a-button>
      <!-- <a-upload
        name="file"
        :showUploadList="false"
        :multiple="false"
...
export default {
  ...
  data() {
    return {
      ...
      url: {
        ...
        uploadFileUrl: '/sys/file/uploadFile',
      },
      dictOptions: {},
  ...
  created() {
    this.queryParam.bucket = 'attachment'
    this.loadData()
  },
  methods: {
    searchReset() {
